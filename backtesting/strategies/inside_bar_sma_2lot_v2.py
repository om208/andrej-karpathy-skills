...
class InsideBarSMA2LotV2Strategy(Strategy):
    """
    2-Lot Modified Inside Bar + SMA Strategy

    Rules:
    1. Entry: Inside bar + SMA(96) touch + Volume spike (like original)
    2. Position: 2 LOTS
       - Lot 1: Exit at +250 pips OR at 159 minutes (whichever first)
    ...
    def __init__(self, df, initial_capital=100, risk_per_trade=7, max_loss=10,
                 ...
                 lot1_tp_pips=250, volume_threshold=1.5):
    ...
    def backtest(self):
        ...
        for idx in range(1, len(df)):
            ...
            if position is None:
                ...
                # Lot 2: Exit only at 159 minutes
